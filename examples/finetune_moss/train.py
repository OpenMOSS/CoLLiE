...
config = CollieConfig.from_pretrained(
    pretrained_model, tp_size=2, dp_size=2, pp_size=2, train_epochs=100,
    eval_per_n_steps=0, eval_per_n_epochs=1, train_micro_batch_size=1,
...
train_dataset, val_dataset = get_dataset(tokenizer, data_dir, num=120, test_size=12)
# TODO
