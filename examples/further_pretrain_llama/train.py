...
from collie import EvalMonitor, PPLMetric
...
def get_dataset(tokenizer):
    ...
    if args.domain == "python":
        for i in range(10):
            ...
            data_path = f"/mnt/petrelfs/share_data/llm_data/raw-starcoder-0821/train/code/python/train-000{i:02}-of-00059_train.jsonl"
            with open(data_path, "r") as f:
                for line in f:
                    train_dataset.append({'text': json.loads(line)['content']})
        data_path = f"/mnt/petrelfs/share_data/llm_data/raw-starcoder-0821/train/code/python/train-00010-of-00059_train.jsonl"
        num = 0
        with open(data_path, "r") as f:
            for line in f:
                num += 1
        ...
        data_path = f"/mnt/petrelfs/share_data/llm_data/raw_data_0831_link/train/cn/baidu-baike/merged-1.jsonl"
        data_num = 2e6
        num = 0
        with open(data_path, "r") as f:
            for line in f:
