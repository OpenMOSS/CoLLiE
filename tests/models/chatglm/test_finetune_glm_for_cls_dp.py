import sys
sys.path.append("../../../")
from collie import Trainer, EvaluatorForPerplexity, ChatGLMForCausalLM, CollieConfig, PPLMetric, AccuracyMetric, DecodeMetric, CollieDatasetForTraining, CollieDatasetForClassification, \
...
traine_dataset = CollieDatasetForTraining(train_dataset, 
                                          tokenizer=AutoTokenizer.from_pretrained("THUDM/chatglm-6b", trust_remote_code=True, add_eos_token=True))
