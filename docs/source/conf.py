...
man_pages = [(master_doc, 'CoLLiE', 'CoLLiE Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'CoLLiE', 'CoLLiE Documentation', author, 'CoLLiE',
     'A tool for 3d parallelism.', 'Miscellaneous'),
]
